...
import { Database, ArrowLeft, ExternalLink, Terminal, Code2, Zap, BookOpen } from "lucide-react";
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-muted-foreground">
            How to integrate App Ports DB into your projects — auto-assign ports, generate clients, and use the OpenAPI spec.
          </p>
